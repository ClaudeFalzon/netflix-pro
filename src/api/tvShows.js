...
export const actionTvShows = [
  {
    ...
    title: "Breaking Bad",
    description:
      "When a high school teacher realises that he's dying from cancer, he turns his life around and tries to provide for his family before he leaves this world for good. Walter White turns to his former student Jesse Pinkman and starts making drugs!",
    image:
  ...
  },
  {
    ...
    description:
      "The first superhero show on this list isn't quite like the others. While many Netflix action shows aim for an edgier and grittier narrative, this series based on the successful graphic novel aims to capture the heart and spirit of the source material.",
    image:
...
export const newTvShows = [
  ...
  },
  {
    ...
    title: "Narcos: Mexico",
    description:
      "The third and final season of the spin-off that we didn't know we needed continues on without its big bad Miguel Ángel Félix Gallardo (Diego Luna) after his arrest in the Season 2 finale, but that just means there's more chaos to be had in the ruckus to become the new Mexican drug kingpin.",
    image:
